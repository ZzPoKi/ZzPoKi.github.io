!function () {
    var t = (window.innerWidth + window.innerHeight) / 8, n = document.getElementById("background"),
        e = n.getContext("2d"), o = 1, i = void 0, r = void 0, a = [], d = void 0, h = void 0,
    ...
    for (var c = 0; c < t; c++) a.push({x: 0, y: 0, z: .2 + .8 * Math.random()});
    m(), function t() {
